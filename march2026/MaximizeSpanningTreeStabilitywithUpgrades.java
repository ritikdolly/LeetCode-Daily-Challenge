...
public class MaximizeSpanningTreeStabilitywithUpgrades {
    ...
    public static void main(String[] args) {
        Solution sol = new MaximizeSpanningTreeStabilitywithUpgrades().new Solution();
        int n = 4;
        int[][] edges = {{0, 1, 3, 1}, {1, 2, 2, 0}, {2, 3, 4, 0}, {0, 3, 5, 0}};
        int k = 1;
        System.out.println(sol.maxStability(n, edges, k)); // Output: 4
    }
}