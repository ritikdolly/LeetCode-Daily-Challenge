...
public class NumberofSetsofKNonOverlappingLineSegments {
    ...
    // approach : Combinatorics (Stars and Bars Theorem)
    class Solution {
    ...
    public static void main(String[] args) {
        Solution solution = new NumberofSetsofKNonOverlappingLineSegments().new Solution();
        int n = 4;
        int k = 2;
        System.out.println(solution.numberOfSets(n, k)); // Output: 5
    }
}
