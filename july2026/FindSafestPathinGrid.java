...
public class FindSafestPathinGrid {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.maximumSafenessFactor(grid1)); // Output: 1
        ...
        System.out.println(sol.maximumSafenessFactor(grid2)); // Output: 0
        ...
        System.out.println(sol.maximumSafenessFactor(grid3)); // Output: 1
    }
}
